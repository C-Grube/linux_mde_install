...
#               curl -k https://raw.githubusercontent.com/C-Grube/linux_mde_install/main/linux_mde_install-ubuntu22-04.sh --output linux_mde_install-ubuntu22-04.sh && bash linux_mde_install-ubuntu22-04.sh MicrosoftDefenderATPOnboardingLinuxServer.py
